...
import com.android.settings.derpfest.buttons.preference.*;
import com.android.settings.derpfest.utils.DeviceUtils;
import com.android.settings.derpfest.utils.TelephonyUtils;
...
public class ButtonSettings extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final int torchLongPressPowerTimeout = Settings.System.getInt(resolver,
                DerpFestSettings.System.TORCH_LONG_PRESS_POWER_TIMEOUT, 0);
        ...
        if (hasMenuKey) {
            ...
            Action pressAction = Action.fromSettings(resolver,
                    DerpFestSettings.System.KEY_MENU_ACTION, Action.MENU);
        ...
        if (hasAssistKey) {
            ...
            Action pressAction = Action.fromSettings(resolver,
                    DerpFestSettings.System.KEY_ASSIST_ACTION, Action.SEARCH);
            mAssistPressAction = initList(KEY_ASSIST_PRESS, pressAction);

            Action longPressAction = Action.fromSettings(resolver,
                    DerpFestSettings.System.KEY_ASSIST_LONG_PRESS_ACTION, Action.VOICE_SEARCH);
        ...
        if (hasAppSwitchKey) {
            ...
            Action pressAction = Action.fromSettings(resolver,
                    DerpFestSettings.System.KEY_APP_SWITCH_ACTION, Action.APP_SWITCH);
        ...
        if (hasVolumeKeys) {
            ...
            final boolean volumePanelOnLeft = Settings.Secure.getIntForUser(resolver,
                    DerpFestSettings.Secure.VOLUME_PANEL_ON_LEFT, 0, UserHandle.USER_CURRENT) != 0;
    ...
    public void onResume() {
        ...
        if (mHomeAnswerCall != null) {
            ...
            final boolean homeButtonAnswersCall =
                (incallHomeBehavior == DerpFestSettings.Secure.RING_HOME_BUTTON_BEHAVIOR_ANSWER);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mBackLongPressAction ||
            ...
            handleListChange(mTorchLongPressPowerTimeout, newValue,
                    DerpFestSettings.System.TORCH_LONG_PRESS_POWER_TIMEOUT);
            return true;
            ...
            Settings.System.putInt(getContentResolver(),
                    DerpFestSettings.System.ENABLE_TASKBAR, ((Boolean) newValue) ? 1 : 0);
            return true;
        }
        return false;
    }
    ...
    private static void writeDisableNavkeysOption(Context context, boolean enabled) {
        Settings.System.putIntForUser(context.getContentResolver(),
                DerpFestSettings.System.FORCE_SHOW_NAVBAR, enabled ? 1 : 0, UserHandle.USER_CURRENT);
    }

    private void updateDisableNavkeysOption() {
        boolean enabled = Settings.System.getIntForUser(
                requireActivity().getContentResolver(),
                DerpFestSettings.System.FORCE_SHOW_NAVBAR, 0, UserHandle.USER_CURRENT) != 0;
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        if (preference == mSwapVolumeButtons) {
            ...
            Settings.System.putInt(requireActivity().getContentResolver(),
                    DerpFestSettings.System.SWAP_VOLUME_KEYS_ON_ROTATION, value);
    ...
    private void handleToggleHomeButtonAnswersCallPreferenceClick() {
        Settings.Secure.putInt(getContentResolver(),
                DerpFestSettings.Secure.RING_HOME_BUTTON_BEHAVIOR, (mHomeAnswerCall.isChecked()
                        ? DerpFestSettings.Secure.RING_HOME_BUTTON_BEHAVIOR_ANSWER
                        : DerpFestSettings.Secure.RING_HOME_BUTTON_BEHAVIOR_DO_NOTHING));
    }
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
        ...
        protected boolean isPageSearchEnabled(Context context) {
            // Enable page search only if DerpFest features are available.
            return context.getResources()
                    .getBoolean(R.bool.config_show_derp_features_settings);
        }
